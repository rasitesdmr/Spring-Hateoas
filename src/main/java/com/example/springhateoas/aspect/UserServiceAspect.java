...
public class UserServiceAspect {
    ...
    @Before("execution(* com.example.springhateoas.service.*.createUser(..))")
    ...
    @After("execution(* com.example.springhateoas.service.*.createUser(..))")
    public void createUserAfter(JoinPoint joinPoint) {
        logger.info("Kullanıcı Kaydedildi");
        logger.info("{}", joinPoint);
    }

    @Around("execution(* com.example.springhateoas.service.*.createUser(..))")
    ...
    @Before("execution(* com.example.springhateoas.service.*.getAllUsers(..))")
    ...
    @After("execution(* com.example.springhateoas.service.*.getAllUsers(..))")
    public void getUsersBeforeAfter(JoinPoint joinPoint) {
        logger.info("Kullanıcı listesi oluşturuldu ");
        logger.info("{}", joinPoint);
    }

    @Around("execution(* com.example.springhateoas.service.*.getAllUsers(..))")
